...
export const ChartCustomizer: React.FC<ChartCustomizerProps> = ({
  ...
  const renderSectionHeader = (key: keyof SectionState, title: string, icon: string) => (
            ...
            <div className="section-content">
              <div className="input-row">
                ...
                <div className="size-inputs">
                  <input
                    ...
                    onChange={e => onFigureChange({ ...figure, width: Number(e.target.value) })}
                    min={200}
                    max={2000}
                  />
                  <span>×</span>
                  <input
                    ...
                    onChange={e => onFigureChange({ ...figure, height: Number(e.target.value) })}
                    min={200}
                    max={1500}
                  />
                  <span>px</span>
              ...
              <div className="input-row">
                ...
                <select
                  ...
                  onChange={e => onFigureChange({ ...figure, dpi: Number(e.target.value) })}
                >
              ...
              <div className="input-row">
                ...
                <div className="color-input-row">
                  <input
                    ...
                    onChange={e => onFigureChange({ ...figure, background: e.target.value })}
                  />
                  <label className="checkbox-label">
                    <input
                      type="checkbox"
                      checked={figure.transparent || false}
                      onChange={e => onFigureChange({ ...figure, transparent: e.target.checked })}
                    />
                    Transparent
                  </label>
                </div>
              ...
              <div className="input-row">
                ...
                <select
                  ...
                  onChange={e => onFontChange({ ...font, family: e.target.value as FontFamily })}
                >
            ...
            <div className="section-content">
              <div className="input-row">
                ...
                <input
                  type="text"
                  value={title.text || ""}
                  onChange={e => onTitleChange({ ...title, text: e.target.value })}
              ...
              <div className="input-row compact">
                <div className="mini-input">
                  ...
                  <input
                    ...
                    onChange={e => onTitleChange({ ...title, font_size: Number(e.target.value) })}
                    min={8}
                    max={32}
                  />
                </div>
              ...
              <div className="input-row">
                ...
                <div className="label-row">
                  <input
                    type="text"
                    value={xLabel.text || ""}
                    onChange={e => onXLabelChange({ ...xLabel, text: e.target.value })}
                    placeholder="X Axis"
                  />
                  <input
                    type="number"
                    value={xLabel.font_size || 11}
                    onChange={e => onXLabelChange({ ...xLabel, font_size: Number(e.target.value) })}
                    min={8}
                    max={24}
                    className="small"
                  />
              ...
              <div className="input-row">
                ...
                <div className="label-row">
                  <input
                    type="text"
                    value={yLabel.text || ""}
                    onChange={e => onYLabelChange({ ...yLabel, text: e.target.value })}
                    placeholder="Y Axis"
                  />
                  <input
                    type="number"
                    value={yLabel.font_size || 11}
                    onChange={e => onYLabelChange({ ...yLabel, font_size: Number(e.target.value) })}
                    min={8}
                    max={24}
                    className="small"
                  />
              ...
              <div className="input-row compact">
                <div className="mini-input">
                  ...
                  <input
                    ...
                    onChange={e => onTicksChange({ ...ticks, font_size: Number(e.target.value) })}
                    min={6}
                    max={20}
                  />
                </div>
                <div className="mini-input">
                  ...
                  <input
                    ...
                    onChange={e => onTicksChange({ ...ticks, rotation: Number(e.target.value) })}
                    min={-90}
                    max={90}
                  />
                </div>
              ...
              <div className="input-row">
                <label className="checkbox-label full">
                  <input
                    ...
                    onChange={e => onGridChange({ ...grid, show: e.target.checked })}
                  />
                  Show Grid
                </label>
              </div>
                  ...
                  <div className="input-row compact">
                    <div className="mini-input">
                      ...
                      <select
                        ...
                        onChange={e => onGridChange({ ...grid, style: e.target.value as LineStyle })}
                      >
                  ...
                  <div className="input-row compact">
                    <div className="mini-input">
                      ...
                      <input
                        ...
                        onChange={e => onGridChange({ ...grid, alpha: Number(e.target.value) / 100 })}
                      />
                    </div>
                    <div className="mini-input">
                      <label>Axis</label>
                      <select
                        ...
                        onChange={e => onGridChange({ ...grid, axis: e.target.value as GridAxis })}
                      >
              ...
              <div className="input-row">
                <label className="checkbox-label full">
                  <input
                    ...
                    onChange={e => onLegendChange({ ...legend, show: e.target.checked })}
                  />
                  Show Legend
                </label>
              </div>
                    ...
                    <div className="mini-input">
                      <label className="checkbox-label">
                        <input
                          ...
                          onChange={e => onLegendChange({ ...legend, frame: e.target.checked })}
                        />
                        Frame
                      </label>
                    </div>
            ...
            <div className="section-content">
              <div className="input-row">
                ...
                <select
                  ...
                  onChange={e => onStyleChange({ ...style, palette: e.target.value })}
                >
              ...
              <div className="input-row">
                ...
                <div className="slider-row">
                  <input
                    ...
                    onChange={e => onStyleChange({ ...style, alpha: Number(e.target.value) / 100 })}
                  />
              ...
              {(plotType === "line" || plotType === "scatter") && (
                <div className="input-row">
                  ...
                  <input
                    ...
                    onChange={e => onStyleChange({ ...style, linewidth: Number(e.target.value) })}
                    min={0.5}
                    max={10}
                    step={0.5}
                  />
              ...
              {plotType === "scatter" && (
                <div className="input-row">
                  ...
                  <input
                    ...
                    onChange={e => onStyleChange({ ...style, marker_size: Number(e.target.value) })}
                    min={10}
                    max={500}
                  />
                </div>
              ...
              <div className="input-row">
                ...
                <input
                  ...
                  onChange={e => onStyleChange({ ...style, edgecolor: e.target.value })}
                />
              </div>
            </div>
          )}
            ...
            <div className="section-content">
              <div className="spine-grid">
                <label className="checkbox-label">
                  <input
                    ...
                    onChange={e => onSpinesChange({ ...spines, top: e.target.checked })}
                  />
                  Top
                </label>
                <label className="checkbox-label">
                  <input
                    ...
                    onChange={e => onSpinesChange({ ...spines, right: e.target.checked })}
                  />
                  Right
                </label>
                <label className="checkbox-label">
                  <input
                    ...
                    onChange={e => onSpinesChange({ ...spines, bottom: e.target.checked })}
                  />
                  Bottom
                </label>
                <label className="checkbox-label">
                  <input
                    ...
                    onChange={e => onSpinesChange({ ...spines, left: e.target.checked })}
                  />
                  Left
                </label>
              </div>
              ...
              <div className="input-row">
                ...
                <input
                  ...
                  onChange={e => onSpinesChange({ ...spines, color: e.target.value })}
                />
              </div>
            </div>
          )}
